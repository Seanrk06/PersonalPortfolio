                      ...
                      <Popover.Panel className="z-10 transform shadow-lg">
                        <div className="bg-customGray text-white rounded-lg p-5 w-fit z-10">
                          <div className="text-center">
                            ...
                            <p className="md:mt-1 md:text-md lg:text-lg text-xs">{project.description}</p>
                            <p className="md:mt-1 md:text-md lg:text-lg text-xs">Source Code: <a className="underline" href={project.code}>Here</a></p>
                            <p className="md:mt-1 md:text-md lg:text-lg text-xs">Competition Submission: <a className="underline" href={project.submission}>Here</a></p>
                            <p className="md:mt-1 md:text-md lg:text-lg text-xs">Live Website: <a className="underline" href={project.link}>Here</a></p>
                          </div>
                        </div>
                      </Popover.Panel>
                    </Transition>
